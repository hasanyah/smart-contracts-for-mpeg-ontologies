...
<FormSection title="Parties" targetId="partyList" :data="parties" type="Party"/>
<FormSection title="Deontics" targetId="deonticsList" :data="deontics" type="Deontic"/>
<FormSection title="Actions" targetId="actionList" :data="actions" type="Action"/>
<FormSection title="Objects" targetId="objectList" :data="objects" type="ObjectComp"/>
</template>
